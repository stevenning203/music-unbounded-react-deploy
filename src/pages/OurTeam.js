...
import jason_wong from '../team-member-portraits/jason_wong.png';
    ...
    return(
        <div id = "our-team-page-wrapper">
            ...
            <div id = "our-team-page-catalog">
                ...
                <TeamMember image = {christie_leung} name = "Christie Leung" instrument = "Violin/Piano" blurb = "Hey, I'm Christie! I'm currently studying at UBC. I have been playing violin and piano since I was 4 and have completed DipABRSM in both instruments. I organized the Intergenerational Classic Music Event, partnered with the Edmonton Senior Center during the pandemic to promote music within the community. I look forward to meeting some of you soon!" />
                ...
                <TeamMember image = {jason_wong} name = "Jason Wong" instrument = "Piano" blurb = "Hello, I am Jason! I have played piano for over 14 years now and I am currently preparing for my RCM Grade 10 Piano Exam. Other instruments that I play are the guitar and the trumpet, both of which I have played for over 10 years as well. I am classically trained but I prefer playing contemporary, ragtime, and jazz. I have also made arrangements as well as composed music throughout my years of practice, and I hope to share this passion with many others." />
